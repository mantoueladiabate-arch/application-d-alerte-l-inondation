...
*{
      ...
      .slider{ 
       position: relative;
       width: 500px;/*largeur de la boite*/
      height:250px;/*hauteur la boite*/
      transform-style :preserve-3d;
       animation: rotate 30s linear infinite;/*nom de l'animation*/
    ...
    .slider span img{
        ...
        width: 100%; /*la largueur des images*/
        height: 100%;/*la hauteur des images*/
        border-radius: 10px; /*centrer les images*/
        object-fit: cover;/*la forme des bordure des images*/
        transform: 2s;
                    ...
                    <li>
                      <a href="#"><i class="fa fa-circle-o"></i>Années<i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview">
                          ...
                          <li><a href="#prevision"><i class="fa fa-circle-o"></i> 2020</a></li>
