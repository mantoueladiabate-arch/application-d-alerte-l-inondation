    ...
    <div class = "contener">
      ...
      <header class="main-header">
        ...
        <a href="../index.php" class="logo">
          ...
          <span class="logo-lg"><b>Photothèques</b></span>
        </a>
                    ...
                    <li>
                      <a href="#"><i class="fa fa-circle-o"></i>Années<i class="fa fa-angle-left pull-right"></i></a>
                        <ul class="treeview">
                          ...
                          <li><a href="photo2020/index.php"><i class="fa fa-circle-o"></i>2020</a></li>
